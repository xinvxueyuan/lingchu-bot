...
- A set of currently implemented and tested Milky group management command handlers.
...
- Milky group management is the currently implemented and tested business path. Other adapters and non-group-management capabilities depend on later implementation and tests.
