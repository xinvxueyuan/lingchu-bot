...
## Docs Site Tests and Lint

The docs site uses Vitest for unit tests and ESLint for code checks:
...
After changing `apps/docs`, run both test and lint to confirm no regressions.
