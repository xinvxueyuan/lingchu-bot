...
The message store is implemented in `services/messagestore.py`. It hooks into NoneBot's event processing pipeline and records structured summaries rather than raw message content.
