...
NapCat currently expects the announcement `image` field to be readable from the NapCat side. If Lingchu Bot and NapCat run in different filesystems, configure the announcement image path bridge in the user configuration guide.
