...
<img
  ...
  alt="Lingchu Bot user guide overview"
  width="960"
  height="540"
  loading="lazy"
/>
...
1. [Getting started](../tutorials/getting-started)
2. [Why commands are locale-exclusive](./commands)
3. [Configuration](../reference/configuration)
4. [Troubleshooting](../how-to/troubleshoot)
