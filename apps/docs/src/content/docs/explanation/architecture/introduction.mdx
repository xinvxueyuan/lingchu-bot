...
<Badge variant="accent">~onebot.v11</Badge> active <Badge variant="destructive">~milky</Badge> <Badge variant="destructive">~qq</Badge> <Badge variant="destructive">~onebot.v12</Badge> removed
...
For detailed adapter configuration and API differences, see [Adapter system](../../reference/architecture/adapter-system). For platform-, protocol-, and implementation-specific command references, see [Platforms](../platforms).
