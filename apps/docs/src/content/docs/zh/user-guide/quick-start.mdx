...
![Lingchu Bot 快速开始运行设置|960x493|loading=lazy](/images/docs/quick-start-runtime.webp)
...
<CardGrid>
  <Card href="/zh/user-guide/commands" title="命令">
    当前群管理命令和别名
  </Card>
  <Card href="/zh/user-guide/configuration" title="配置">
    运行时设置、适配器选择和路径配置
  </Card>
  <Card href="/zh/user-guide/troubleshooting" title="故障排除">
    常见启动和群管理问题
  </Card>
</CardGrid>
