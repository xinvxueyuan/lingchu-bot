...
generation. See [Deploy TIPO with llama.cpp](/how-to/deploy/tipo-llama-cpp).
...
- [Environment Variables](./environment-variables) — .env variable reference
- [Adapter Selection](/how-to/configure/adapter) — LINGCHUAdapter configuration
- [Superuser Identity](/how-to/configure/superuser) — LINGCHU_SUPERUSERS settings
