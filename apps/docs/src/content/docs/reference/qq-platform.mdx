...
<Aside type="caution" title="Unsupported adapters">
...
| OneBot V11 | [NapCat](/how-to/connect/qq-napcat) | Group announcement + group avatar |
...
- [Connect QQ via NapCat](/how-to/connect/qq-napcat) — NapCat Docker setup and NapCat-specific commands
- [Connect QQ via SnowLuma](/how-to/connect/qq-snowluma) — SnowLuma Docker setup
- [QQ Commands](./commands) — Full command reference including remote management
- [OneBot V11 default implementation](./architecture/onebot-v11-default) — Default handler reference
