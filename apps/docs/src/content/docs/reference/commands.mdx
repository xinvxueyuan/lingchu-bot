...
Feedback text and command trigger language use `LINGCHU_LOCALE` from the current NoneBot configuration. See [Internationalization](../how-to/contribute/i18n).
...
See [Deploy TIPO with llama.cpp](/how-to/deploy/tipo-llama-cpp) for
