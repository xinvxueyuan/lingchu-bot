...
### Protected-user auto-restore (OneBot V11)
...
For how command triggers and menu visibility consume these permissions, see [Architecture](/explanation/architecture/introduction) and [Adapter system](./adapter-system).
