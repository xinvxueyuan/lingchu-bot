...
- `发送群公告` / `send-announcement` — gated by implementation version (see [NapCat](/how-to/connect/qq-napcat))
- `设置群头像` / `set-group-avatar` — gated by implementation version (see [NapCat](/how-to/connect/qq-napcat))
