...
This tutorial does not connect to a real QQ account — that comes next in [Connect your first adapter](./first-adapter).
...
<CardGrid>
  <Card href="./first-adapter" title="Connect your first adapter">
    Connect NapCat and send your first group management command.
  </Card>
