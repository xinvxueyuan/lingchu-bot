  ...
  source: {
    getPages: vi.fn(() => [
      // en page with a zh counterpart
      {
        ...
        locale: 'en',
        data: { title: 'Commands', description: 'desc', lastModified: '2025-01-01' },
      },
...
describe('app/sitemap', () => {
  ...
  it('emits one entry per docs page with the right URL prefix', () => {
    ...
    expect(urls).toContain('https://lingchu.zone.id/docs/developer-guide/architecture/introduction');
  });
