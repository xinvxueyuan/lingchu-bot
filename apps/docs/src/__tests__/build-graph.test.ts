...
describe('buildGraph', () => {
  it('should return a graph with nodes and links', () => {
  ...
  it('should create a node for each page', () => {
    const graph = buildGraph();
  ...
  it('should include title and description in nodes', () => {
    const graph = buildGraph();
  ...
  it('should create links for valid extracted references', () => {
    const graph = buildGraph();
  ...
  it('should skip links for unresolved references', () => {
    const graph = buildGraph();
  ...
  it('should not create links for pages without extracted references', () => {
    const graph = buildGraph();
