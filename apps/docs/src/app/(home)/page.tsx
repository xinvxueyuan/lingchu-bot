...
const features = [
  [
    ...
    "Menus and handlers use the same command keys, so operators only see actions they can run.",
  ],
  [
    "OneBot V11 first",
    "QQ group operations document the active OneBot V11 path without hiding adapter boundaries.",
  ],
  [
    "Runtime controls",
    "Silent mode and the handle gate let maintainers pause noisy replies without losing recovery commands.",
  ],
] as const;
...
const docLinks = [
  ...
  [
    ...
    "/docs/developer-guide/architecture/introduction",
  ],
] as const;
