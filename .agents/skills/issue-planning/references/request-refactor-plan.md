...
2. Explore the repo to verify their assertions and understand the current state of the codebase. Use `gitnexus-exploring` and `gitnexus-impact-analysis` to understand dependencies.
...
8. Create a GitHub issue with the refactor plan using `mcp_GitHub_create_issue`. Use the following template:
