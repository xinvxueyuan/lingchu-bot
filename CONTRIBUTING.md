...
1. **讨论与规划**：对于重大改动或新功能，请先在 [Issues](https://github.com/xinvxueyuan/xinvxueyuan/issues) 中讨论，获取维护者反馈。
...
联系方式：通过 [Issues](https://github.com/xinvxueyuan/xinvxueyuan/issues) 或 [Discussions](https://github.com/xinvxueyuan/xinvxueyuan/discussions) 与维护者沟通。
...
- [项目主页](https://github.com/xinvxueyuan/lingchu-bot)
- [文档](docs/)
