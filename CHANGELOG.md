...
## [0.7.0.dev1] - 2026-08-24

次要版本开发预发布：缺陷批次修复（fail-closed 收敛、静默失败治理、性能优化）与统一持久化层。
...
[Unreleased]: https://github.com/xinvxueyuan/lingchu-bot/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/xinvxueyuan/lingchu-bot/compare/v0.6.3...v0.7.0
[0.7.0.dev1]: https://github.com/xinvxueyuan/lingchu-bot/compare/v0.6.3...v0.7.0.dev1
