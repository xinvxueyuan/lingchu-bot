...
from src.plugins.nonebot_plugin_lingchu_bot.handle.qq.group import command_triggers
...
def test_command_trigger_catalog_uses_configured_locale(
    ...
    monkeypatch.setattr(command_triggers, "get_configured_locale", lambda: "zh_CN")
    assert trigger.primary == "禁言"
    assert trigger.aliases == {"禁言用户", "禁言群成员", "禁言成员", "禁", "封禁"}

    monkeypatch.setattr(command_triggers, "get_configured_locale", lambda: "en_US")
