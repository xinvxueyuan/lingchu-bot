...
This project is indexed by GitNexus as **lingchu-bot** (2091 symbols, 4221 relationships, 174 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
