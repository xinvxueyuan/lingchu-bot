...
This project is indexed by GitNexus as **lingchu-bot** (2002 symbols, 4122 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
