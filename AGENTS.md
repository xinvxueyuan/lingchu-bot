...
This project is indexed by GitNexus as **lingchu-bot** (1844 symbols, 3798 relationships, 149 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
