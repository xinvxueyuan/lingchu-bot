...
This project is indexed by GitNexus as **lingchu-bot** (1573 symbols, 3241 relationships, 118 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
